...
$(function(){
    ...
    $('#hosp_order_id').change(function(){
        ...
        $('#doctor_id').html('<option value="">全部</option>');
        if(orderId==''){
            return;
        }
        $.ajax({
    ...
    $(".position-container").on('click','.btn-show-show',function(){
        ...
        $(".btn-show-hidden").css({position:"relative",left: '0px',"display":"inline-block"});
