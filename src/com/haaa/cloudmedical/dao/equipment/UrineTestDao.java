...
public class UrineTestDao extends EquipmentDao {
	...
	public Map<String, Object> getMostRecentData(long user_id) {
		String sql = "SELECT findName(a.URO)URO,findName(a.BLD)BLD,findName(a.BIL)BIL,findName(a.KET)KET,findName(a.GLU)GLU,findName(a.PRO)PRO,a.PH,findName(a.NIT)NIT,findName(a.LEU)LEU,a.SG,findName(a.VC)VC,DATE_FORMAT(a.create_date,'%Y-%m-%d %H:%i')datetime  FROM c_urine_test a LEFT JOIN c_equipment_use b ON a.equipment_use_order_id = b.order_id WHERE b.user_id=? order by b.create_date desc limit 1";
