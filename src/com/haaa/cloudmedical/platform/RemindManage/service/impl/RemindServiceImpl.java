...
public class RemindServiceImpl implements RemindService {
    ...
    @Override
    public Page queryPage(User user,String doctor_name, int pageno, String datemin, String datemax) {
        String sql_info = "select a.user_id, a.user_name,a.user_card,a.user_phone, findname(a.user_sex) user_sex,getahdi(a.ahdi_value) ahdi_value,"
                          + "a.user_age,findname(a.user_marriage) user_marriage,findname(a.user_work) user_work,chronic,doctor_name "
                          + "from n_user a left join d_patient b on a.user_id = b.patient_id left join d_doctor c on b.doctor_id = c.doctor_id where chronic != '0'";
    ...
    public Object deleteMedicine(String order_id) {
        String sql = "delete from r_medication_remind where order_id=" + order_id;
        return this.dao.execute(sql);
    }
    ...
    public Object deleteDoctor(String order_id) {
        String sql = "delete from r_doctor_remind where order_id=" + order_id;
        return this.dao.execute(sql);
    }
    ...
    public Object deleteMeasure(String order_id) {
        String sql = "delete from r_measurement_remind where order_id=" + order_id;
        return this.dao.execute(sql);
    }
}
