...
public class User {
	...
	private String user_medicare_card;
	private String user_marriage;
	private String user_address;
	private String user_phone;
	private String user_phs_phone;
	private String user_pwd;
	private String email;
	private String user_work;
	private String user_medical_burden;
	...
	private String ahdi_value;
	private String user_nation;
	private String clientId;
	private String os_type;
	private String qq;
	private String wechat;
	private String ahdi_level;
	private String chronic;
	private String mrs_value;
	private String mrs_level;
	...
	public String getUser_medicare_card() {
		return user_medicare_card;
	}

	public void setUser_medicare_card(String user_medicare_card) {
		this.user_medicare_card = user_medicare_card;
	}
	...
	public String getUser_phs_phone() {
		return user_phs_phone;
	}

	public void setUser_phs_phone(String user_phs_phone) {
		this.user_phs_phone = user_phs_phone;
	}
	...
	public String getUser_medical_burden() {
		return user_medical_burden;
	}

	public void setUser_medical_burden(String user_medical_burden) {
		this.user_medical_burden = user_medical_burden;
	}
	...
	public String getAhdi_value() {
		return ahdi_value;
	}

	public void setAhdi_value(String ahdi_value) {
		this.ahdi_value = ahdi_value;
	}
	...
	public String getAhdi_level() {
		return ahdi_level;
	}

	public void setAhdi_level(String ahdi_level) {
		this.ahdi_level = ahdi_level;
	}
	...
	public String getMrs_value() {
		return mrs_value;
	}

	public void setMrs_value(String mrs_value) {
		this.mrs_value = mrs_value;
	}

	public String getMrs_level() {
		return mrs_level;
	}

	public void setMrs_level(String mrs_level) {
		this.mrs_level = mrs_level;
	}
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_type=" + user_type + ", user_is_vip=" + user_is_vip + ", user_name="
				+ user_name + ", user_sex=" + user_sex + ", user_age=" + user_age + ", user_birthday=" + user_birthday
				+ ", user_card=" + user_card + ", user_height=" + user_height + ", user_weight=" + user_weight
				+ ", user_blood=" + user_blood + ", user_medicare_card=" + user_medicare_card + ", user_marriage="
				+ user_marriage + ", user_address=" + user_address + ", user_phone=" + user_phone + ", user_phs_phone="
				+ user_phs_phone + ", user_pwd=" + user_pwd + ", email=" + email + ", user_work=" + user_work
				+ ", user_medical_burden=" + user_medical_burden + ", user_waist=" + user_waist
				+ ", picture_head_order_id=" + picture_head_order_id + ", user_head_pic_upload_index="
				+ user_head_pic_upload_index + ", picture_card_front_order_id=" + picture_card_front_order_id
				+ ", user_card_front_upload_index=" + user_card_front_upload_index + ", picture_card_back_order_id="
				+ picture_card_back_order_id + ", user_card_back_upload_index=" + user_card_back_upload_index
				+ ", create_date=" + create_date + ", update_date=" + update_date + ", user_source=" + user_source
				+ ", user_flag=" + user_flag + ", ahdi_value=" + ahdi_value + ", user_nation=" + user_nation
				+ ", clientId=" + clientId + ", os_type=" + os_type + ", qq=" + qq + ", wechat=" + wechat
				+ ", ahdi_level=" + ahdi_level + ", chronic=" + chronic + ", mrs_value=" + mrs_value + ", mrs_level="
				+ mrs_level + ", passport=" + passport + ", mainland=" + mainland + ", country=" + country
