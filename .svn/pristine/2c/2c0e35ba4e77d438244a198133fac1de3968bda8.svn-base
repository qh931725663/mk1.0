...
public class UserAppController {
	...
	public Map<String, Object> validateLogin(String loginToken, String verson, String os_type, String user_type) {
		...
		if (os_type.equals("2")) {
			...
			if (user_type.equals(Constant.USER_TYPE_PATIENT)) {
				if(verson.equals("1.0.1")){
					map.put("update", 1);
					map.put("verson", "1.0.2");
					logger.info("update:"+map.get("update").toString());
					logger.info("verson:"+map.get("verson").toString());
					return map;
				}
