...
public class ClinicReport {
	...
	private String clinic_report_time;
	private String hosp_order_id;
	private String hosp_name;
	private String department_order_id;
	private String department_name;
	private String doctor_id;
	private String clinic_report_disease;
	private String clinic_report_result;
	...
	public String getClinic_report_time() {
		return clinic_report_time;
	}

	public void setClinic_report_time(String clinic_report_time) {
		this.clinic_report_time = clinic_report_time;
	}
	...
	public String getClinic_report_disease() {
		return clinic_report_disease;
	}

	public void setClinic_report_disease(String clinic_report_disease) {
		this.clinic_report_disease = clinic_report_disease;
	}

	public String getClinic_report_result() {
		return clinic_report_result;
	}

	public void setClinic_report_result(String clinic_report_result) {
		this.clinic_report_result = clinic_report_result;
	}
	...
	public String toString() {
		return "ClinicReport [order_id=" + order_id + ", report_no=" + report_no + ", user_id=" + user_id
				+ ", user_name=" + user_name + ", clinic_report_time=" + clinic_report_time + ", hosp_order_id="
				+ hosp_order_id + ", hosp_name=" + hosp_name + ", department_order_id=" + department_order_id
				+ ", department_name=" + department_name + ", doctor_id=" + doctor_id + ", clinic_report_disease="
				+ clinic_report_disease + ", clinic_report_result=" + clinic_report_result + ", create_date="
				+ create_date + ", update_date=" + update_date + ", report_doctor=" + report_doctor
				+ ", report_upload_index=" + report_upload_index + ", doctor_name=" + doctor_name
