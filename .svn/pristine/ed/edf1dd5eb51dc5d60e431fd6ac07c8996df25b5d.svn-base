...
public class LungCapacityDao extends EquipmentDao {
	...
	public Map<String, Object> getMostRecentData(long user_id) {
		String sql = "SELECT a.fvc,a.fvc_rate,a.fev1,a.fev1_rate,a.pef,a.pef_rate,DATE_FORMAT(a.create_date,'%Y-%m-%d %H:%i')datetime FROM c_lung_capacity a LEFT JOIN c_equipment_use b ON a.equipment_use_order_id = b.order_id WHERE b.user_id=? order by b.create_date DESC limit 1";
