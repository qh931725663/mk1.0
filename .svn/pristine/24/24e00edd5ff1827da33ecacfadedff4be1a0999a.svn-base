...
public class NewsManageController {
	...
	public ResponseDTO add(BannerNews news) {
		...
		if(news.getSection().equals("5")||news.getSection().equals("6")||news.getSection().equals("1")||news.getSection().equals("3")){
	...
	@ResponseBody
	public boolean push(String order_id,String is_push_to_doctor){
		boolean flag = service.push(order_id,is_push_to_doctor);
		return flag;
	}
