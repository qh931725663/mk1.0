...
public class BasicInfoSurveyController {
	...
	@RequestMapping(value={"/getBasicInfoSurvey.action"},method={RequestMethod.GET})
	public InfoJson getBasicInfoSurvey(String user_id){
		...
		try {
			...
			infoJson = service.getBasicInfoSurvey(user_id);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		}
		return infoJson;		
	...
	@RequestMapping(value={"/getAppBasicInfoSurvey.action"},method={RequestMethod.GET})
	public InfoJson getAppBasicInfoSurvey(String user_id){
		...
		try {
			...
			infoJson = service.getAppBasicInfoSurvey(user_id);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		}
		return infoJson;		
